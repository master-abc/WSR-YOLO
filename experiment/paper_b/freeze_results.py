...
try:
    from .common import PAPER_B_DIR, atomic_json_dump, environment_snapshot, sha256_file
except ImportError:
    from common import PAPER_B_DIR, atomic_json_dump, environment_snapshot, sha256_file
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=PAPER_B_DIR / "frozen_results")
