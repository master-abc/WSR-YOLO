...
run_mechanism() {
    local dataset=$1
    local gpu=$2
    local data=${project}/experiment/wsr/generated/datasets/${dataset}/dataset.yaml
    local weights=${project}/experiment/wsr/generated/runs/controlled/${dataset}/wsr_yolo11s_p3_r25/seed_13/weights/best.pt
...
run_latency() {
    ...
    local gpu=$3
    local data=${project}/experiment/wsr/generated/datasets/${dataset}/dataset.yaml
    local baseline=${project}/experiment/wsr/generated/runs/controlled/${dataset}/yolo11s/seed_13/weights/best.pt
    local candidate=${project}/experiment/wsr/generated/runs/controlled/${dataset}/wsr_yolo11s_p3_r25/seed_13/weights/best.pt
...
required=(
    "${project}/experiment/wsr/generated/runs/controlled/deeppcb/yolo11s/seed_13/weights/best.pt"
    "${project}/experiment/wsr/generated/runs/controlled/deeppcb/wsr_yolo11s_p3_r25/seed_13/weights/best.pt"
    "${project}/experiment/wsr/generated/runs/controlled/dspcbsd_plus/yolo11s/seed_13/weights/best.pt"
    "${project}/experiment/wsr/generated/runs/controlled/dspcbsd_plus/wsr_yolo11s_p3_r25/seed_13/weights/best.pt"
)
