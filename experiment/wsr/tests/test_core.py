...
from experiment.wsr.corruptions import CORRUPTIONS, corrupt
from experiment.wsr.ablation import subset_coco_annotations, validation_run_directory
from experiment.wsr.aggregate_operating_points import aggregate as aggregate_operating_points
from experiment.wsr.analyze_false_positive import analyze as analyze_false_positives
from experiment.wsr.coco_evaluator import evaluate_coco_predictions, predict_yolo_to_coco
from experiment.wsr.confirmatory_summary import MODELS as CONFIRMATORY_MODELS
from experiment.wsr.confirmatory_summary import SEEDS as CONFIRMATORY_SEEDS
from experiment.wsr.confirmatory_summary import summarize as summarize_confirmatory
from experiment.wsr.consensus_ensemble import consensus_detections
from experiment.wsr.external_detr import prediction_rows
from experiment.wsr.external_ultralytics import normalize_prediction_image_ids
from experiment.wsr.frequency_interventions import haar_filters, intervene
from experiment.wsr.mitigation_summary import _negative_sample_key
from experiment.wsr.operating_point import operational_metrics, select_threshold
from experiment.wsr.pilot import benchmark_path, diagnostics_path, evaluate_gate, result_path
from experiment.wsr.pretrained import remap_source_key
from experiment.wsr.prepare_hard_negatives import prepare as prepare_hard_negatives
from experiment.wsr.reference_verifier import box_change_score, sample_key
from experiment.wsr.validation_postprocess import suppress_overlaps
from experiment.wsr.common import sha256_file
from experiment.wsr.stats import format_cell, format_latex_cell, latex_escape


class WSRReproducibilityTests(unittest.TestCase):
    ...
    def test_validation_only_pilot_gate(self):
        with tempfile.TemporaryDirectory() as directory:
            root = Path(directory)
            protocol_file = root / "protocol.yaml"
            ...
            with patch(
                "experiment.wsr.pilot.environment_snapshot",
