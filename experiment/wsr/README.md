...
python -m experiment.wsr.stats `
  ...
  --output experiment\wsr\generated\tables
```
...
python -m experiment.wsr.ablation materialize
python -m experiment.wsr.ablation train --variant route_p3_12p5 --seed 13 --device 0
```
...
```powershell
python -m experiment.wsr.run prepare --dataset dspcbsd_plus --coco
python -m experiment.wsr.external bootstrap --repos-root D:\wsr_repos
python -m experiment.wsr.external materialize --dataset dspcbsd_plus --repos-root D:\wsr_repos --device 0
```
...
python -m experiment.wsr.mechanism_diagnostics --weights PATH\best.pt --data experiment\wsr\generated\datasets\deeppcb\dataset.yaml --output route.json

# Generate eight corruption families at five severity levels.
python -m experiment.wsr.corruptions experiment\wsr\generated\datasets\deeppcb\dataset.yaml experiment\wsr\generated\robustness\deeppcb

# Generate pixel-level LL, high-frequency, and directional-subband interventions.
python -m experiment.wsr.frequency_interventions experiment\wsr\generated\datasets\deeppcb\dataset.yaml experiment\wsr\generated\frequency\deeppcb

# Evaluate generated suites with one frozen checkpoint.
python -m experiment.wsr.evaluate_suite --weights PATH\best.pt --suite-root experiment\wsr\generated\frequency\deeppcb --output frequency_result.json --model wsr_yolo11s_p3_r25 --dataset deeppcb --seed 13

# Generate few-shot subsets.
python -m experiment.wsr.few_shot experiment\wsr\generated\datasets\dspcbsd_plus\dataset.yaml experiment\wsr\generated\few_shot\dspcbsd_plus

# Build a genuine zero-shot cross-domain pair over five shared classes.
python -m experiment.wsr.cross_domain remap experiment\wsr\generated\datasets\deeppcb\dataset.yaml experiment\wsr\generated\cross_domain\deeppcb_common5
python -m experiment.wsr.cross_domain remap experiment\wsr\generated\datasets\dspcbsd_plus\dataset.yaml experiment\wsr\generated\cross_domain\dspcbsd_common5
python -m experiment.wsr.cross_domain pair experiment\wsr\generated\cross_domain\deeppcb_common5\dataset.yaml experiment\wsr\generated\cross_domain\dspcbsd_common5\dataset.yaml experiment\wsr\generated\cross_domain\deep_to_dsp
```
...
```powershell
python -m experiment.wsr.negative_aware prepare `
  --base-data experiment\wsr\generated\datasets\deeppcb\dataset.yaml `
  --template-list PATH\deeppcb_official_templates.txt `
  --output experiment\wsr\generated\negative_aware\dataset

python -m experiment.wsr.negative_aware train `
  --data experiment\wsr\generated\negative_aware\dataset\dataset.yaml `
  ...
  --positive-test-annotations experiment\wsr\generated\coco\deeppcb\annotations\instances_test.json `
  --positive-test-images experiment\wsr\generated\coco\deeppcb\test

# Stage 2: choose the recipe on seed 13 validation data, then reproduce it unchanged.
python experiment\wsr\negative_aware.py prepare `
  --base-data experiment\wsr\generated\negative_aware_local\base\dataset.yaml `
  --template-list experiment\wsr\generated\negative_aware_local\base\templates.txt `
...
python experiment\wsr\prepare_hard_negatives.py `
  --base-data experiment\wsr\generated\negative_aware_local\frac100\dataset.yaml `
  --negative-audit experiment\wsr\generated\negative_aware_local\stage2_seed13_negative_train.json `
...
```powershell
python experiment\wsr\consensus_ensemble.py select `
...
python experiment\wsr\consensus_ensemble.py evaluate `
...
```powershell
python experiment\wsr\validation_postprocess.py `
...
```powershell
python -m experiment.wsr.benchmark --weights PATH\best.pt --data experiment\wsr\generated\datasets\deeppcb\dataset.yaml --output speed_fp16.json --half
python -m experiment.wsr.freeze_results --root experiment\wsr\generated\runs
python -m experiment.wsr.stats --root experiment\wsr\frozen_results --output experiment\wsr\generated\tables
```
