...
try:
    ...
    from common import REPRODUCIBILITY_DIR, PROJECT_DIR, atomic_json_dump, class_names, dataset_sources, environment_snapshot, file_hashes, load_yaml, resolve_path, sha256_file, sha256_text, write_lines
    from coco_evaluator import evaluate_coco_predictions, predict_yolo_to_coco
    from pretrained import transfer_pretrained
    from yolo_to_coco import convert_dataset
...
def train_validation_only(
    ...
    source_files = [
        ...
        REPRODUCIBILITY_DIR / "split_dataset.py",
        protocol["_path"],
    ]
